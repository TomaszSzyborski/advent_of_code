...
def is_report_safe(report: list[int]) -> bool:
    """
    Determines if a report is safe based on the following conditions:
    - The levels are either all increasing or all decreasing.
    - Any two adjacent levels differ by at least one and at most three.

    Args:
        report (list of int): A list of integer levels in the report.
...
def main():
    ...
    safe_reports_count = sum(is_report_safe(list(map(int, report.split()))) for report in data)
