    ...
    for data_point in prepared_data:
        ...
        for peq in eq:
            ...
            if data_point.result == it_result:
                ...
                break # for part 1
    return sum(results) # for part 1


if __name__ == '__main__':
    actual_test_part_1 = check("part_1_test_input.txt")
    assert actual_test_part_1 == 3749, f"Was {actual_test_part_1}"
    print(f"Part 1 test: {actual_test_part_1}")

    actual_part_1 = check("puzzle_input.txt")
    print(f"Part 1: {actual_part_1}")
    assert actual_part_1 == 1611660863222
