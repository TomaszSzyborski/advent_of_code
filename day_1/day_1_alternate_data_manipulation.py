...
total_calories_per_elf = [sum(map(int,chunk)) for chunk in split_at(calories_data, lambda data: data == '')]
...
top_three_elves = elves_sorted_by_largest_amount_of_calories[:3]
